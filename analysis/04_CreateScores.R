...
# Author:  R. Foraita
#
# Purpose: Built scores on complete data
#
# ------------------------------------------------------------------------------
imp <- readRDS("data/MI-10.rds")
daten <- mice::complete(imp, action = "long", include = TRUE)
...
daten <- daten %>%
          ...
          -c(att_cereal_4_t0, att_cheese_1_t0, att_cheese_2_t0,
           ...
           z_insulin_t0, z_insulin_t1, z_insulin_t3,
           z_hdl_t0, z_hdl_t1, z_hdl_t3,
           z_mets_t0, z_mets_t1, z_mets_t3
        )
    )
...
# addmargins(table(daten$meal_togeth_t3, daten$meal_togeth_new_t3)/10)
...
### ! SAVE ---------------------------------------------------------------------
saveRDS(daten.mids, "data/MI-10-scores-mids.rds")
### ----------------------------------------------------------------------------
